...
void menuRadioTrainer(event_t event)
{
  ...
  lcdDrawText(0, MENU_HEADER_HEIGHT + 1, "RX");
  lcdDrawNumber(5 * FW, MENU_HEADER_HEIGHT + 1, trainerGetRxRateHz(), RIGHT);
  lcdDrawText(7 * FW, MENU_HEADER_HEIGHT + 1, "Mix");
  lcdDrawNumber(13 * FW, MENU_HEADER_HEIGHT + 1, trainerGetSampleRateHz(), RIGHT);
